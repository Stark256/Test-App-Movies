...
data class TVDetails (
    ...
    @SerializedName("episode_run_time") var episodeRunTime: ArrayList<Int>?,
    @SerializedName("name") var title: String?,
    @SerializedName("original_name") var originalName: String?,
    @SerializedName("overview") var overview: String?,
    @SerializedName("tagline") var tagline: String?,
    @SerializedName("status") var status: String?,
    @SerializedName("networks") var networks: ArrayList<Network>?,
...
//    @SerializedName("created_by") var createdBy: Any?,
//    @SerializedName("homepage") var homepage: Any?,
//    @SerializedName("in_production") var inProduction: Any?,
//    @SerializedName("languages") var languages: Any?,
//    @SerializedName("last_air_date") var lastAirDate: Any?,
//    @SerializedName("last_episode_to_air") var lastEpisodToAir: Any?,
//    @SerializedName("next_episode_to_air") var nextEpisodToAir: Any?,
//    @SerializedName("number_of_episodes") var numberOfEpisods: Any?,
//    @SerializedName("number_of_seasons") var numberOfSeasons: Any?,
//    @SerializedName("origin_country") var originCountry: Any?,
//    @SerializedName("original_language") var priginalLanguage: Any?,
